            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Menghitung Lingkaran</h1>

                        <div class="card-body">
                             <form role="form" action="" method="post">
                                <div class="form-group">
                                    <label class="small mb-3" for="inputEmailAddress">Masukkan jari-jari</label>
                                    <input class="form-control" name="jari_lingkaran" type="number" placeholder="Masukkan jari-jari" required/>
                                </div>
                            ...
                            <?php 
                                        ...
                                        $querypilihlingkaran = mysqli_query($koneksi, "SELECT * FROM bangun_datar WHERE bangun_datar='lingkaran'") or die(mysqli_connect_error()); //query menampilkan bangun_ruang: lingkaran
