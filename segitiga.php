            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Menghitung Segitiga</h1>
                        
                        
                        <div class="card-body">
                             <form role="form" action="" method="post">
                                <div class="form-group">
                                    <label class="small mb-3" for="inputEmailAddress">Masukkan alas segitiga</label>
                                    <input class="form-control" name="alas_segitiga" type="number" placeholder="Masukkan alas" required/>
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-3" for="inputPassword">Masukkan tinggi segitiga</label>
                                                <input class="form-control" name="tinggi_segitiga" type="number" placeholder="Masukkan tinggi" required />
                                            </div>
                        ...
                        <?php 
                                        ...
                                        $querypilihsegitiga = mysqli_query($koneksi, "SELECT * FROM bangun_datar WHERE bangun_datar='segitiga'") or die(mysqli_connect_error()); //query menampilkan bangun_ruang: segitiga
